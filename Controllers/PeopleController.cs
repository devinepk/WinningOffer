...
namespace WinningOffer.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public PeopleController(WinningOfferContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Person_Id,CreatedDate,ListCompany,ListAgent,ListAgentPhone")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Person_Id,CreatedDate,ListCompany,ListAgent,ListAgentPhone")] Person person)
        {
